	        ...
	        success: function(reviews) {
	            ...
	            if (Array.isArray(reviews)) {
	                ...
	                $('.product-item').each(function() {
	                    const currentProdId = $(this).data('prod-id');
	                    const dlvySttus = $(this).data('dlvy-sttus');
	                    let hasReview = false;
						let memberNo = '';
	                    ...
	                    if (dlvySttus === '배송중' || dlvySttus === '배송완료') {
	                        ...
	                        if (!hasReview || reviewDelAt === 'Y') {
	                            reviewButtonHtml = 
								'<button class="ms-btn-1 reviewBtn" onclick="location.href=\'/prms/market/member/reviewProdUI?prodId=' 
								+ currentProdId + '\'">후기작성</button>';
	                        } else {
	                ...
	                console.error('리뷰데이터 에러 :', reviews);
	            }
	        },
