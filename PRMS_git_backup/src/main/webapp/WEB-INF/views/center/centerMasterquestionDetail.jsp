...
<link rel="stylesheet"
	href="${cPath }/resources/css/franstyle/franQna.css">
			...
			<h4>☑️고객문의 상세☑️</h4>
				...
				<tbody>
					<tr>
						...
						<td class="contentCn">${center.ctrBbsCn}</td>
					</tr>
				</tbody>
			</table>
		</div>
							...
							<div class="comment-list">
								<div class="comment border p-3 mb-3 rounded">
									<div class="comment-body">
										...
										<div class="detailBtn">
										<form method="get" action="${cPath }/main/master/centerMasterUpdate/${center.ctrBbsNo}/${qnaview.qnaAnswerId}" >
...
<%-- 			</form> --%>
		...
		<div class="noticeBtn-group">
			<div class="d-lg-flex align-items-center">
				<div class="ms-auto">
			 	 <button type="button" class="btn btn-theme" style="margin-right: 2px;"" onclick="goMarketQna()">목록조회</button>
				</div>
				<div class="ms-auto">
					<a href="${cPath }/main/master/centerMasterInsert/${center.ctrBbsNo}"
						class="btn btn-theme">답변등록</a>
				</div>
			</div>
		</div>
	</div>
...
document.addEventListener("click", async (event) => {
	...
	//관리자 qna 내역 목록가기 버튼 이벤트
		const cPath = "${cPath}";
		console.log("cPath 경로:", cPath);
		
		function goMarketQna(){
			 location.href = cPath + "/main/master/centerMasterList";
		}
