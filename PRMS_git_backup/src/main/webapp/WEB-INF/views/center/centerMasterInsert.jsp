...
<!-- 								<span style="color:#aaa;" id="counter">(0 / 최대 200자)</span> -->
								...
								<div class="ms-auto">
								<a href="<c:url value='/main/master/${center.ctrBbsNo}/quest'/>" class="btn btn-theme">이전으로</a>
								</div>
								<div class="ms-auto">
									<button type="button" class="btn btn-theme Btn-margin" id="insertBtn">등록하기</button>
								</div>
								</div>
								</div>
							</form:form>
