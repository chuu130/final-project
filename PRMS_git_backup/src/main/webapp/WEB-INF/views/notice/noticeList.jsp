...
<div class="d-flex mb-3">
	<div>
		<ul class="breadcrumb">
			<c:url value="${cPath}/main/master/noticeList" var="noticeListUrl" />
	...
	<div class="tab-content p-4">
		<div class="tab-pane fade show active" id="allTab">
			...
			<div class="input-group flex-nowrap mb-4" id="searchUI">
				<div>
				    <select class="noticelistselect" name="condition.searchType" id="searchType">
				...
				<div class="flex-fill">
					<div class="input-group">
						...
						<input type="text" id="inputContent" class="form-control ps-35px" placeholder="검색조건을 입력하세요"  onkeydown="keyDown(this, event)">
					</div>
				</div>
			</div>
			<!-- END input-group -->
			...
			<!-- 검색 폼 -->
			<form id="searchform" method="get" action="${cPath}/main/master/noticeList" modelAttribute="condition">
...
<script src="${cPath}/resources/js/app/master/masterNotice.js"></script>